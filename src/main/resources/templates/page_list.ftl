                    ...
                    ${r'<#list page.recordList as entity>'}
                        ${r'<tr id="tr_entity_${entity.id}">'}
                            ...
                            <td>
                                ...
                                &nbsp;
                                ${r'<a href="javascript:void(0)" data-id="${entity.id}" data-action="${deleteAction}" data-confirm="是否删除?" onclick="return PageDialog.showConfirmModal(this);" title="删除"><i class="bi-trash"></i></a>'}
                            </td>
                            <#list entity.properties as property>
                                <#if !property.primary>
